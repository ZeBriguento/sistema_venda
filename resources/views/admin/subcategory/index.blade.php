    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-tag"></i> Subcategorias
                <a href="{{ route('subCategories.create') }}" class="btn btn-primary" type="button"> <i class="fa fa-plus-circle"></i>
                    Novo</a>
                                                                        ...
                                                                        <td>
                                                                            <div class="text-center">
                                                                                ...
                                                                                <a class="btn btn-primary btn-sm"
                                                                                    href="{{ route('subCategories.show', ['subCategory' => $subCategory]) }}"
                                                                                    type="button" style="color: white"><i
                                                                                        class="fas fa-key"></i></a>
                                                                                        <a class="btn btn-secondary btn-sm"
                                                                                        href="{{ route('subCategories.edit', ['subCategory' => $subCategory]) }}"
                                                                                        type="button" style="color: white"><i
