...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-newspaper"></i> Blogs
                <a href="{{ route('blogs.create') }}" class="btn btn-primary" type="button"> <i class="fa fa-plus-circle"></i>
                    Novo</a>
                                                                        ...
                                                                        <td>
                                                                            <div class="text-center">
                                                                                ...
                                                                                <a class="btn btn-primary btn-sm"
                                                                                    href="{{ route('blogs.show', ['blog' => $blog]) }}" type="button"
                                                                                    style="color: white"><i
                                                                                        class="fas fa-key"></i></a>
                                                                                <a class="btn btn-secondary btn-sm"
                                                                                    href="{{ route('blogs.edit', ['blog' => $blog]) }}"
