                ...
                <div class="tile-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @if ($errors->has('first_name')) is-invalid @endif" type="text"
                            placeholder="Primeiro Nome" id="first_name" name="first_name" value="{{ $profile->first_name }}"
                            autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @if ($errors->has('last_name')) is-invalid @endif" type="text"
                            placeholder="Sobrenome" id="last_name" name="last_name" value="{{ $profile->last_name }}"
                            autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @if ($errors->has('phone')) is-invalid @endif" type="number"
                            placeholder="Telefone" id="phone" name="phone" value="{{ $profile->phone }}" autofocus>
                        @if ($errors->has('phone'))
                            <div class="form-control-feedback" style="color: red">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @if ($errors->has('nif_number')) is-invalid @endif" type="text"
                            placeholder="NIF" id="nif_number" name="nif_number" value="{{ $profile->nif_number }}" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @if ($errors->has('address')) is-invalid @endif" type="text"
                            placeholder="Endereço" id="address" name="address" value="{{ $profile->address }}" autofocus>
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit"><i
                            ...
                            class="btn btn-danger" href="{{ route('login.index') }}"><i
